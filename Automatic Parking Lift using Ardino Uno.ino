// Arduino Combined Sensor Code with L296 Motor Driver
#include <Servo.h>
...
if (digitalRead(IRSensor) == HIGH) 
    {
      ...
      servo.write(0); // Rotate servo motor to 90 degrees
